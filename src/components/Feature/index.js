...
const  Feature=()=><div> 
    <div className="featureComTopLayout">
        <p className="featurestyle">Feature</p>
        <h2 className="featureComfirsthead">Analytics that feels like it’s from the future</h2> 
        <p className="featureComPara">Powerful, self-serve product and growth analytics to help you convert, engage, and retain more users. Trusted by over 4,000 startups.</p>
    </div> 
    <div>
